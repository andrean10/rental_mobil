...
class RiwayatPesananWebView extends GetView<DataPesananWebController> {
  const RiwayatPesananWebView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: controller.streamRiwayatPesanan(),
